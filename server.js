...
// Import TripAdvisor routes from the API implementation
const tripadvisorRoutes = require('./server/routes/tripadvisor-api');
...
// We're now using the modular tripadvisorRoutes from tripadvisor-api.js
const { exec } = require('child_process');

// Register the TripAdvisor API routes
